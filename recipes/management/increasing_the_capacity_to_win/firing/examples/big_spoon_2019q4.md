...
REDACTED has impressed me these last six months with his wisdom married to his practicality. More than any other engineer at Doxel he is able to propose simple, elegant computer vision solutions that are likely to do 90% of what we need. He also sees team and company issues before most other employees and has helped me make decisions on what to build and how to build it.
